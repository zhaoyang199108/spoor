...
public class JpushClientUtil {
    ...
    private final static String appKey = "223241a2c534f9bc65ac07b9";
 
    private final static String masterSecret = "dcd0208e2b1948dc4b30f157";
...
//                        .build())
    ...
    int i =	JpushClientUtil.sendToRegistrationId("171976fa8a85c6787ce", "通知内容白标题", "评论标题", "这是个评论", "自定义参数");
